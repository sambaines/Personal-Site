...
import giftLoader1 from '../../images/case-study/gift-loader-mob-01.png';
import giftLoader2 from '../../images/case-study/gift-loader-mob-02.png';
...
<div class="desktop-only">
    ![Customize Image](../../images/case-study/gifting-speed.png)
</div>
<div class="mobile-only">
...
<div class="mobile-only">
    <Carousel images={[giftLoader1, giftLoader2]} 
    alts={[]} />
</div>